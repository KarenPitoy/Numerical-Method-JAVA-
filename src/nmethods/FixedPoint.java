...
public class FixedPoint extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(180, 110, 130, 40);
        ...
        jPanel1.add(jLabel4);
        jLabel4.setBounds(220, 170, 170, 40);
        ...
        jLabel7.setText("xL");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(490, 110, 30, 40);
        ...
        equation.setBounds(290, 110, 190, 40);
        ...
        jScrollPane2.setBounds(30, 460, 870, 280);
        ...
        jButton4.setBounds(630, 110, 150, 40);
        ...
        jPanel1.add(graph);
        graph.setBounds(150, 230, 660, 210);
        ...
        jLabel5.setText("FIXED POINT ITERATION METHOD");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(180, 20, 640, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FixedPoint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FixedPoint().setVisible(true);
            }
        });
    }
...
private double g(double x) {
    ...
    double fx = evaluateFunction(equation.getText(), x);
